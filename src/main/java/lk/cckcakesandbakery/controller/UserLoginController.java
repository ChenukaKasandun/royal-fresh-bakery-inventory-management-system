...
public class UserLoginController {
    ...
    @Autowired
    private BCryptPasswordEncoder bCryptPasswordEncoder; // In order to encrypt Admin's password
    ...
    public ModelAndView uiDashboardPage() {
        ...
        dashboardPage.addObject("loggedusername", auth.getName());// This returns the name of the logged user in the
                                                                  // dashboard
